                        ...
                        <CardHeader>
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="d-flex gap-3">
                                    <Input name="email" type="text" placeholder="Buscar" onChange={(e) => setSearch(e.target.value)} value={search} /> {}
                                    <Button size="sm" color="primary" onClick={() => setShowModal(!showModal)}>Agregar estudiante</Button>
                                </div>
                            </div>
                        </CardHeader>
                        <CardBody>
